  ...
  return (
    ...
    >
      <div className="bg-card border border-border rounded-2xl p-8 shadow-lg hover:shadow-xl hover:border-accent/50 transition-all duration-300">
        <h2 className="text-3xl font-bold mb-2 text-foreground">Request a Quote</h2>
        <p className="text-muted-foreground mb-8">Fill out the form below and we'll send you a detailed quote within 24 hours</p>
        ...
        {submitted ? (
          <div className="bg-accent/10 border border-accent rounded-lg p-6 text-center animate-bounce-in">
            ...
            <h3 className="text-xl font-semibold text-accent mb-2">Quote Request Sent!</h3>
            <p className="text-muted-foreground">Thank you for your interest. We'll prepare your quote and get back to you shortly.</p>
          </div>
        ) : (
          <>
            {error && (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="animate-stagger-5">
                <label className="block text-sm font-medium mb-2 text-foreground">Service Required *</label>
                <select
                  name="service"
              ...
              <div className="animate-stagger-6">
                <label className="block text-sm font-medium mb-2 text-foreground">Project Timeline</label>
                <select
                  name="timeline"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="animate-stagger-7">
                <label className="block text-sm font-medium mb-2 text-foreground">Estimated Budget</label>
                <select
                  name="budget"
                ...
                >
                  ...
                  <option value="small">Under ₦5M</option>
              ...
              <div className="animate-stagger-8">
                <label className="block text-sm font-medium mb-2 text-foreground">Project Location</label>
                <input
                  type="text"
                  name="location"
            ...
            <div className="animate-stagger-1" style={{ animationDelay: "0.8s" }}>
              ...
              <textarea
                ...
                placeholder="Please provide detailed information about your project requirements, specifications, and any specific needs..."
              ></textarea>
            </div>
